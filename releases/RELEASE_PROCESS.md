# Release Process for Zeltro CLI

## Creating a GitHub Release

### Step 1: Prepare Release Assets
The `.deb` package is stored in `releases/linux/zeltro-cli_latest.deb` in this repository.

### Step 2: Create GitHub Release
1. Go to GitHub → Releases → "Create a new release"
2. Create a new tag (e.g., `v1.0.0`)
3. **Upload the file directly** as a release asset:
   - Upload `releases/linux/zeltro-cli_latest.deb`
   - Make sure it's named exactly `zeltro-cli_latest.deb` in the release
