...
# Zeltro GUI Installer — Ubuntu / Debian / Linux Mint
#
...
for arg in "$@"; do
    case $arg in
        --help)
            echo "Zeltro GUI Ubuntu Installer"
            echo ""
...
CLI_INSTALLER_URL="https://raw.githubusercontent.com/CaneBayComputers/zeltro-cli/master/install-ubuntu.sh"
