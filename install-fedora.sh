...
# Podium GUI Installer — Fedora / RHEL
#
...
for arg in "$@"; do
    case $arg in
        --help)
            echo "Podium GUI Fedora Installer"
            echo ""
...
CLI_INSTALLER_URL="https://raw.githubusercontent.com/CaneBayComputers/podium-cli/master/install-fedora.sh"
